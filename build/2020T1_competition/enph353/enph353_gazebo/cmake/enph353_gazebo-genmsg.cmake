...
get_filename_component(_filename "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/SubmitPlate.srv" NAME_WE)
add_custom_target(_enph353_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "enph353_gazebo" "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/SubmitPlate.srv" "sensor_msgs/Image:std_msgs/Header"
)

get_filename_component(_filename "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/GetLegalPlates.srv" NAME_WE)
add_custom_target(_enph353_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "enph353_gazebo" "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/GetLegalPlates.srv" ""
)
...
_generate_srv_cpp(enph353_gazebo
  "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/SubmitPlate.srv"
  "${MSG_I_FLAGS}"
...
_generate_srv_cpp(enph353_gazebo
  "/home/fizzer/machine-learning-353/src/2020T1_competition/enph353/enph353_gazebo/srv/GetLegalPlates.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/enph353_gazebo
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/enph353_gazebo)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/enph353_gazebo\")")
  # install generated code
  install(
